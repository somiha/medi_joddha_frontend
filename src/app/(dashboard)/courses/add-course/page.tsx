// app/courses/add-course/page.tsx
"use client";
...
export default function AddCoursePage() {
  ...
  const validateForm = () => {
    ...
    if (is_draft && is_published) {
      newErrors.status = "Course cannot be both draft and published";
    }
          ...
          <div className="space-y-4 border rounded-lg p-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-500">
                  Make course visible to users immediately
                </p>
              </div>
              <Switch
                id="publish-mode"
            ...
            <div className="p-3 bg-gray-50 rounded-md">
              ...
              <p className="text-xs text-gray-600 mt-2">
                {is_draft && is_published
                  ? "⚠️ Course cannot be both draft and published"
                  : is_draft
                  ? "Course will be saved as draft (not visible to users)"
                  : is_published
                  ? "Course will be published immediately"
                  : "Course will be saved with no status set"}
              </p>
            </div>
          </div>
